...
mod test {
    ...
    fn asset_metadata_roundtrip() {
        ...
        assert_eq!(asset_metadata.serialize().to_lower_hex_string().as_str(),"");
    ...
    fn prop_key_serialize() {
        ...
        assert_eq!(
            ...
            format!("08{}00{}", PSET_HWW_PREFIX.as_hex(), asset_id.into_tag())
        );
    ...
    fn elip0100_test_vector() {
        ...
        let txid_hex_non_convention = txid.as_byte_array().to_vec().to_lower_hex_string();
        assert_eq!(
